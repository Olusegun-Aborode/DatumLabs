...
const CARDS: Dune[] = [
  ...
  { name: "All Datum dashboards", tag: "Full Index", desc: "Browse the complete Dune profile — every public dashboard authored by the team.", scope: "OPEN PROFILE", href: "https://dune.com/jorel", cat: "index", index: true },
]

const FILTERS = ["All", "Lending", "DEX", "Stablecoin", "Payments", "Risk"]
