  ...
  return (
    <html lang="en">
      <body className={`font-sans antialiased`}>
        ...
        <Analytics />
      {/* v0 – built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-a6afd666-111d-493a-acbe-ce699c9d581c" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_sIxFCmz7N7v?ref=UEI9BI"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-a6afd666-111d-493a-acbe-ce699c9d581c').style.display='none'"
