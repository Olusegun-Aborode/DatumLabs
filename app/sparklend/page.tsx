 ...
 *
 * Ships from a separate Vercel project (repo: sparklend-dashboard). Iframe
 * points at the project's AUTO-FOLLOWING production domain so every
 * `vercel --prod` of that project is reflected here without a re-alias step.
 *
 * Layout mirrors /app/fluid-terminal/page.tsx: flex-col wrapper so the header
 * takes its natural height and the iframe takes flex-1 (avoids the h-screen +
 * h-full collapse where the iframe reports 0 height in some layouts).
 */
